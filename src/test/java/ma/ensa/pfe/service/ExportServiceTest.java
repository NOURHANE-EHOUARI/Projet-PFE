...
class ExportServiceTest {
    ...
    private Soutenance creerSoutenance(Long id,
            ...
            String j1Nom, String j1Prenom, String j2Nom, String j2Prenom,
    ...
    @Test
    @DisplayName("exporterExcel - taille croît avec données")
    void exporterExcel_tailleCroitAvecDonnees() throws IOException {
        ...
        exportService.exporterExcel(new java.util.ArrayList<>(), outVide);
    ...
    @Test
    @DisplayName("exporterPdf - commence par signature PDF")
