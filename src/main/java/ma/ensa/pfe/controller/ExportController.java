...
public class ExportController {
    ...
    public String versions(Model model) {
        ...
        if (base.exists()) {
            ...
            if (dossiers != null) {
                Arrays.sort(dossiers, Comparator.comparingLong(java.io.File::lastModified).reversed());
                for (java.io.File d : dossiers) {
                    ...
                    long size = Arrays.stream(d.listFiles() != null ? d.listFiles() : new java.io.File[0])
